...
wordTarget: 2200
note: >
  An AI Overview is already present on the related query "stamp duty in mumbai".
  This is the strongest AEO target in the cluster, which also makes accuracy
  non negotiable. Every figure below is dated and sourced.
answer: >
  Stamp duty in Mumbai is 6 percent of the chargeable value for a male buyer
  and 5 percent for a female buyer holding in her sole name, both including the
  1 percent metro cess. Registration is 1 percent, capped at 30,000 rupees.
  Duty is charged on the agreement value or the ready reckoner value, whichever
  is higher.
sources:
...
On a flat of one crore, that is 6,00,000 in duty and 30,000 in registration for a male buyer. Our [stamp duty calculator](/tools/stamp-duty-calculator-mumbai) works it out on your own numbers, including the reckoner floor.
...
See the [ready reckoner post](/blog/ready-reckoner-rate-mumbai), which also covers the income tax consequence of a price more than 10 percent below the reckoner rate.
