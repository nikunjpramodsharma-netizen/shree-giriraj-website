...
targetKeyword: security deposit mumbai rent how many months
searchVolume: 0
funnelStage: consideration
wordTarget: 1400
note: >
  No measurable search volume, and included deliberately. It answers a
  question every tenant in this belt asks out loud but rarely types into
  Google, and it corrects two things that get repeated online: that ten months
  is normal here, and that Maharashtra law caps deposits at two. It earns its
  place through internal links, AI citation and being the thing people send
  to a friend.
answer: >
  In Borivali, Kandivali and Malad a deposit of two to three months' rent is
  the norm in newer societies, rising to four, five or six in older buildings
  and premium pockets. No Maharashtra law fixes the number. The two month cap
  people quote comes from a central model law the state has not enacted, so
  the deposit is a term of the agreement, and it is negotiable.
sources:
  ...
  - label: RentDraft, Maharashtra rent agreement format, on the absence of a statutory deposit cap
    url: https://www.rentdraft.in/blog/rent-agreement-format-maharashtra
  - label: Mittiyo, renting a flat in Mumbai in 2026, deposits by building type
    url: https://blogs.mittiyo.com/mittiyo/renting-in-mumbai/
  - label: ListItNow, finding a flat in Mumbai, deposits in the western suburbs
    url: https://listitnow.in/blogs/ultimate-guide-finding-flat-room-rent-mumbai
  - label: PRS Legislative Research, the Model Tenancy Act, 2021
    url: https://prsindia.org/billtrack/the-model-tenancy-act-2021
  - label: TeamLease RegTech, the Maharashtra Rent Control (Amendment) Bill, 2025
    url: https://teamleaseregtech.com/updates/article/44926/maharashtra-rent-control-amendment-bill-2025/
  - label: Lawvaani, security deposit disputes, deductions, wear and tear and remedies
    url: https://lawvaani.com/security-deposit-disputes-in-india-how-tenants-can-legally-recover-unreasonable-deductions-from-uncooperative-landlords/
  - label: Business Standard, NoBroker study on security deposits held in six cities, July 2026
    url: https://www.business-standard.com/markets/news/rs-1-26-trillion-locked-in-as-security-deposit-with-property-owners-study-126071600400_1.html
