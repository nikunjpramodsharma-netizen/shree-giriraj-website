...
heroAlt: "A calculator and a set of keys on a desk beside a property agreement"
targetKeyword: rental yield mumbai
searchVolume: 260
competition: LOW
funnelStage: consideration
wordTarget: 1500
note: >
  Primary keyword measured at 260 a month in India, low competition, on
  8 September 2026 via DataForSEO. The supporting tool keyword, "rental yield
  calculator", runs about 1,900 a month, so this post exists partly to feed
  /tools/rental-yield-calculator. It publishes no yield figure for any suburb,
  deliberately: no citable source for western suburbs yields has been verified
  and the owner's instruction is that no return figures go on the site.
answer: >
  Rental yield is the annual rent a property produces expressed as a percentage
  of what it cost. Gross yield divides a year of rent by the purchase price.
  Net yield subtracts society maintenance, property tax, repairs and vacancy,
  and adds stamp duty, registration, brokerage and fit out to the capital. Net
  is the figure that matters, and it is always lower than gross.
sources:
  - label: "Income Tax Act 1961, section 24(a), the 30 percent standard deduction on income from house property"
  ...
  - label: "DataForSEO, Google search volume for rental yield and property investment terms in India, measured 8 September 2026"
