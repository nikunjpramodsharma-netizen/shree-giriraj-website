...
export async function StickyMobileCTA({ locale }: { locale: string }) {
  ...
  return (
    <div data-sticky-bar data-global-sticky className="fixed inset-x-0 bottom-0 z-40 flex border-t border-brand-indigo/10 bg-white shadow-[0_-4px_16px_rgba(0,0,0,0.06)] md:hidden">
      <a
