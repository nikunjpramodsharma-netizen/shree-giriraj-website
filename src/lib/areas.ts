...
const PAGES: Record<string, Omit<AreaPage, "slug" | "name">> = {
  "borivali-west": {
    ...
    motion: {
      ...
      pocketScenes: [
        { kicker: "West · the shop's own pocket", title: "Chikoowadi", text: "Older cooperative societies alongside newer towers, near the Shimpoli metro and a little further from the station. Quiet, established, and the pocket we know best.", image: { src: "/areas/real/bor-west-skyline.jpg", alt: "Borivali West's towers at sunset, seen across the water", credit: "Aziz, CC0, Wikimedia Commons" } },
        { kicker: "West · East Indian heart", title: "I.C. Colony", text: "A parish from 1547, Mount Poinsur, St. Francis school, the Mandapeshwar caves, and a Christmas market on Brother Cyprian Street. Prices vary more by building age here than anywhere in Borivali.", image: { src: "/areas/real/bor-mount-poinsur.jpg", alt: "The old watch tower at Mount Poinsur beside the Mandapeshwar caves, in I.C. Colony", credit: "Kartik Chandramouli, CC BY-SA 3.0, Wikimedia Commons" } },
        { kicker: "West · the station belt", title: "L.T. Road and Chandavarkar Road", text: "The old commercial heart: the municipal market, the shopping lanes, Veer Savarkar Udyan's 1.5 kilometre track, and a MHADA colony by the Borivali West metro.", image: { src: "/areas/real/bor-station.jpg", alt: "A local train at the platform of Borivali station", credit: "Gannu03, CC BY-SA 4.0, Wikimedia Commons" } },
        { kicker: "East · against the forest", title: "Kulupwadi and Dattapada Road", text: "Ten minutes from the national park gate, Raheja Estate's societies, and Oberoi Sky City rising on 25 acres with possession declared for December 2027.", image: { src: "/areas/real/bor-east.jpg", alt: "Borivali East from above, with towers and the hills of the national park behind", credit: "Rakesh from Bangalore, CC BY-SA 2.0, Wikimedia Commons" } },
      ],
      landmarks: [
        { kicker: "Borivali East", title: "Sanjay Gandhi National Park", text: "103.84 square kilometres, more than two million visitors a year, three to five thousand morning walkers, and the 109 Kanheri caves inside.", image: { src: "/areas/real/bor-sgnp.jpg", alt: "A large tree over a lake inside Sanjay Gandhi National Park", credit: "Rana.p.s, CC BY-SA 4.0, Wikimedia Commons" } },
        { kicker: "Borivali West", title: "Mandapeshwar caves", text: "A Shiva shrine cut from Buddhist viharas near Mount Poinsur, with the ruins of a 1544 Portuguese church above them.", image: { src: "/areas/real/bor-mandapeshwar.jpg", alt: "The rock cut Mandapeshwar caves in Borivali West", credit: "Kartik Chandramouli, CC BY-SA 3.0, Wikimedia Commons" } },
        { kicker: "Across the creek", title: "Gorai and the pagoda", text: "A ten to fifteen minute ferry from Gorai jetty to the village and the 99 metre Global Vipassana Pagoda, inaugurated in 2009.", image: { src: "/areas/real/bor-pagoda.jpg", alt: "The golden dome of the Global Vipassana Pagoda at Gorai", credit: "Joe Ravi, CC BY-SA 3.0, Wikimedia Commons" } },
        { kicker: "Inside the park", title: "Kanheri caves", text: "109 caves cut into the basalt between the first and tenth centuries, a short drive in from the Borivali East gate.", image: { src: "/areas/real/bor-kanheri.jpg", alt: "The rock cut Kanheri caves inside Sanjay Gandhi National Park", credit: "Jawahar Soneji, CC BY-SA 4.0, Wikimedia Commons" } },
      ],
      rents: [
  ...
  kandivali: {
    ...
    motion: {
      ...
      pocketScenes: [
        { kicker: "West · Gujarati heart", title: "Mahavir Nagar", text: "About 450 metres from the Kandivali West metro, the MCA gymkhana, good schools and a vegetarian Khau Galli across several lanes. The highest asking rate in the West.", image: { src: "/areas/real/kan-metro-west.jpg", alt: "The Kandivali West metro station on New Link Road, a short walk from Mahavir Nagar", credit: "Rupturestriker, CC BY-SA 4.0, Wikimedia Commons" } },
        { kicker: "West · the MHADA grid", title: "Charkop", text: "Sectors cut by twelve metre roads and six metre lanes since 1986, mangroves at Sector 8, and a 53 society complex heading for cluster redevelopment that would triple each owner's carpet area.", image: { src: "/areas/real/kan-metro-train.jpg", alt: "A Mumbai Metro yellow line train, the line that runs past Charkop", credit: "Mumbaimetro, CC BY-SA 4.0, Wikimedia Commons" } },
        { kicker: "East · against the forest", title: "Thakur Village and Lokhandwala", text: "Thakur Village is about 50,000 people over two square kilometres with wide internal roads and Thakur College since 1992. Lokhandwala Township beside it is the East's premium gated address.", image: { src: "/areas/real/kan-lokhandwala.jpg", alt: "The towers of Lokhandwala Township in Kandivali East across open ground", credit: "Ask27, CC BY-SA 4.0, Wikimedia Commons" } },
        { kicker: "East · the new Kandivali", title: "Akurli Road", text: "Mahindra's plant since 1948, and beside it Mahindra Vista, Godrej Reserve on 18.5 acres, Kalpataru and Lodha, with Growel's 101 at the highway end.", image: { src: "/areas/real/kan-mahindra.jpg", alt: "The gate of the Mahindra and Mahindra plant on Akurli Road, Kandivali East", credit: "Ask27, CC BY-SA 4.0, Wikimedia Commons" } },
      ],
      landmarks: [
        { kicker: "Kandivali East", title: "Growel's 101", text: "The East's mall on Akurli Road off the highway, with a PVR and more than a hundred brands.", image: { src: "/areas/real/kan-akurli.jpg", alt: "The Akurli metro station on the highway, beside Growel's 101", credit: "Rupturestriker, CC BY-SA 4.0, Wikimedia Commons" } },
        { kicker: "Kandivali West", title: "Raghuleela Mega Mall", text: "Behind Poisar depot since 2009: 800 shops and an INOX, the West's mall.", image: { src: "/areas/real/kan-station.jpg", alt: "Kandivali railway station seen from the footbridge", credit: "Superfast1111, CC BY-SA 3.0, Wikimedia Commons" } },
        { kicker: "Kandivali West", title: "Charkop mangroves", text: "About 136 hectares at the sectors' edge, the West's flood barrier and its bird life.", image: { src: "/areas/real/kan-creek.jpg", alt: "The creek and its mangroves west of Charkop and Gorai, seen from the air", credit: "Trinidade, CC BY-SA 4.0, Wikimedia Commons" } },
        { kicker: "Kandivali East", title: "The national park's edge", text: "Sanjay Gandhi National Park forms the East's boundary, and Thakur Village and Lokhandwala back straight onto it.", image: { src: "/areas/real/kan-sgnp.jpg", alt: "A forest stream inside Sanjay Gandhi National Park", credit: "Ninad Bhosale, CC BY-SA 2.0, Wikimedia Commons" } },
      ],
      rents: [
  ...
  malad: {
    ...
    motion: {
      ...
      pocketsNote: "Asking rates per square foot as reported, with the portal and month. Asking is not the registered price.",
      pocketScenes: [
        { kicker: "West · the office district", title: "Mindspace and the Link Road belt", text: "Paradigm Mindspace since 2004: 0.8 million square feet leased to JP Morgan, Tech Mahindra and Concentrix at 98.6 percent occupancy, with Inorbit and Infiniti beside it. The workforce is Malad's largest source of tenants.", image: { src: "/areas/real/mal-inorbit.jpg", alt: "Inorbit Mall on the Link Road at Mindspace, Malad West", credit: "Rakesh Krishna Kumar, CC BY-SA 2.0, Wikimedia Commons" } },
        { kicker: "West · the premium pocket", title: "Evershine Nagar", text: "Lodha Raj Infinia, Narang Vivenda and Arkade Eden near New Link Road and the Malad West metro, asking around 32,000 rupees per square foot.", image: { src: "/areas/real/mal-palm-court.jpg", alt: "A residential complex with gardens and a pool on the Link Road in Malad West", credit: "Rakesh Krishna Kumar, CC BY-SA 2.0, Wikimedia Commons" } },
        { kicker: "West · the village heart", title: "Orlem and Marve Road", text: "Once Valnai, the village on the curving path. The largest parish in the archdiocese by a 2004 census, St. Anne's since 1916, hockey and football, and 15,000 at the Christmas midnight mass.", image: { src: "/areas/real/mal-st-annes.jpg", alt: "St. Anne's High School in Orlem, Malad West", credit: "J maroon5 2308, CC BY-SA 4.0, Wikimedia Commons" } },
        { kicker: "East · at the park's edge", title: "Rani Sati Marg and Dindoshi", text: "The arterial from the station to the highway, now a metro hotspot, and Dindoshi's Infinity IT Park, civil court and one of BEST's largest depots.", image: { src: "/areas/real/mal-dindoshi.jpg", alt: "The Dindoshi metro station on the Western Express Highway", credit: "Raghav Sethupathy (brother), CC BY-SA 4.0, Wikimedia Commons" } },
      ],
      landmarks: [
        { kicker: "Marve Road", title: "Aksa Beach", text: "One of Mumbai's cleanest, about 15,000 visitors on a weekend, INS Hamla at one end. For sunsets, not swimming.", image: { src: "/areas/real/mal-aksa.jpg", alt: "Sunset over Aksa Beach with people at the water's edge", credit: "E Siva Subramaniam Iyer, CC BY 3.0, Wikimedia Commons" } },
        { kicker: "Madh Island", title: "Madh Fort and the Versova ferry", text: "A seventeenth century Portuguese watchtower under Air Force control, a five minute ferry to Versova, and a bridge cleared in September 2026 for 2029.", image: { src: "/areas/real/mal-madh-fort.jpg", alt: "Madh Fort on its headland, seen from the Versova side", credit: "KartikMistry, CC BY-SA 4.0, Wikimedia Commons" } },
        { kicker: "Marve Road", title: "Marve and Manori", text: "Marve is the quieter beach, with the ferry across the creek to Manori.", image: { src: "/areas/real/mal-manori.jpg", alt: "The wide empty sands of Manori beach", credit: "Sanjaybhagwat, CC BY-SA 4.0, Wikimedia Commons" } },
      ],
      rents: [
