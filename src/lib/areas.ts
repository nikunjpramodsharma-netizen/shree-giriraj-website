...
const PAGES: Record<string, Omit<AreaPage, "slug" | "name">> = {
  "borivali-west": {
    ...
    motion: {
      ...
      pocketScenes: [
        { kicker: "West · the shop's own pocket", title: "Chikoowadi", text: "Older cooperative societies alongside newer towers, near the Shimpoli metro and a little further from the station. Quiet, established, and the pocket we know best.", image: { src: "/premium/mumbai-aerial-green.jpg", alt: "Towers and societies of Mumbai's western suburbs among trees, with the creek beyond" } },
        { kicker: "West · East Indian heart", title: "I.C. Colony", text: "A parish from 1547, Mount Poinsur, St. Francis school, the Mandapeshwar caves, and a Christmas market on Brother Cyprian Street. Prices vary more by building age here than anywhere in Borivali.", image: { src: "/areas/real/bor-mount-poinsur.jpg", alt: "The old watch tower at Mount Poinsur beside the Mandapeshwar caves, in I.C. Colony" } },
        ...
        { kicker: "East · against the forest", title: "Kulupwadi and Dattapada Road", text: "Ten minutes from the national park gate, Raheja Estate's societies, and Oberoi Sky City rising on 25 acres with possession declared for December 2027.", image: { src: "/premium/skyline-trees.jpg", alt: "Residential towers rising beyond a belt of trees" } },
      ],
      landmarks: [
        { kicker: "Borivali East", title: "Sanjay Gandhi National Park", text: "103.84 square kilometres, more than two million visitors a year, three to five thousand morning walkers, and the 109 Kanheri caves inside.", image: { src: "/areas/real/bor-sgnp.jpg", alt: "A large tree over a lake inside Sanjay Gandhi National Park" } },
        { kicker: "Borivali West", title: "Mandapeshwar caves", text: "A Shiva shrine cut from Buddhist viharas near Mount Poinsur, with the ruins of a 1544 Portuguese church above them.", image: { src: "/areas/real/bor-mandapeshwar.jpg", alt: "The rock cut Mandapeshwar caves in Borivali West" } },
        { kicker: "Across the creek", title: "Gorai and the pagoda", text: "A ten to fifteen minute ferry from Gorai jetty to the village and the 99 metre Global Vipassana Pagoda, inaugurated in 2009.", image: { src: "/areas/real/bor-pagoda.jpg", alt: "The golden dome of the Global Vipassana Pagoda at Gorai" } },
        { kicker: "Inside the park", title: "Kanheri caves", text: "109 caves cut into the basalt between the first and tenth centuries, a short drive in from the Borivali East gate.", image: { src: "/areas/real/bor-kanheri.jpg", alt: "The rock cut Kanheri caves inside Sanjay Gandhi National Park" } },
      ],
      rents: [
  ...
  kandivali: {
    ...
    motion: {
      ...
      landmarks: [
        { kicker: "Kandivali East", title: "Growel's 101", text: "The East's mall on Akurli Road off the highway, with a PVR and more than a hundred brands.", image: { src: "/areas/real/kan-akurli.jpg", alt: "The Akurli metro station on the highway, beside Growel's 101" } },
        ...
        { kicker: "Kandivali East", title: "The national park's edge", text: "Sanjay Gandhi National Park forms the East's boundary, and Thakur Village and Lokhandwala back straight onto it.", image: { src: "/areas/real/kan-sgnp.jpg", alt: "A forest stream inside Sanjay Gandhi National Park" } },
      ],
      rents: [
  ...
  malad: {
    ...
    motion: {
      ...
      pocketScenes: [
        ...
        { kicker: "West · the premium pocket", title: "Evershine Nagar", text: "Lodha Raj Infinia, Narang Vivenda and Arkade Eden near New Link Road and the Malad West metro, asking around 32,000 rupees per square foot.", image: { src: "/areas/real/mal-palm-court.jpg", alt: "A residential complex with gardens and a pool on the Link Road in Malad West" } },
        { kicker: "West · the village heart", title: "Orlem and Marve Road", text: "Once Valnai, the village on the curving path. The largest parish in the archdiocese by a 2004 census, St. Anne's since 1916, hockey and football, and 15,000 at the Christmas midnight mass.", image: { src: "/premium/apartments-palms.jpg", alt: "An elegant residential building with balconies and palm trees" } },
        { kicker: "East · at the park's edge", title: "Rani Sati Marg and Dindoshi", text: "The arterial from the station to the highway, now a metro hotspot, and Dindoshi's Infinity IT Park, civil court and one of BEST's largest depots.", image: { src: "/areas/real/mal-dindoshi.jpg", alt: "The Dindoshi metro station on the Western Express Highway" } },
      ],
      landmarks: [
        { kicker: "Marve Road", title: "Aksa Beach", text: "One of Mumbai's cleanest, about 15,000 visitors on a weekend, INS Hamla at one end. For sunsets, not swimming.", image: { src: "/areas/real/mal-aksa.jpg", alt: "Sunset over Aksa Beach with people at the water's edge" } },
        { kicker: "Madh Island", title: "Madh Fort and the Versova ferry", text: "A seventeenth century Portuguese watchtower under Air Force control, a five minute ferry to Versova, and a bridge cleared in September 2026 for 2029.", image: { src: "/areas/real/mal-madh-fort.jpg", alt: "Madh Fort on its headland, seen from the Versova side" } },
        { kicker: "Marve Road", title: "Marve and Manori", text: "Marve is the quieter beach, with the ferry across the creek to Manori.", image: { src: "/areas/real/mal-manori.jpg", alt: "The wide empty sands of Manori beach" } },
      ],
      rents: [
