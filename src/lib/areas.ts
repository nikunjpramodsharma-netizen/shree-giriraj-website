  ...
  kandivali: {
    ...
    motion: {
      ...
      pocketScenes: [
        ...
        { kicker: "West · the MHADA grid", title: "Charkop", text: "Sectors cut by twelve metre roads and six metre lanes since 1986, mangroves at Sector 8, and a 53 society complex heading for cluster redevelopment that would triple each owner's carpet area.", image: { src: "/areas/real/kan-creek.jpg", alt: "The creek and mangroves at the western edge of Charkop and Gorai, seen from the air", credit: "Trinidade, CC BY-SA 4.0, Wikimedia Commons" } },
