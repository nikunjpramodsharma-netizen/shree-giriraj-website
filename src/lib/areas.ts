...
const PAGES: Record<string, Omit<AreaPage, "slug" | "name">> = {
  "borivali-west": {
    ...
    motion: {
      ...
      pocketScenes: [
        { kicker: "West · the shop's own pocket", title: "Chikoowadi", text: "Older cooperative societies alongside newer towers, near the Shimpoli metro and a little further from the station. Quiet, established, and the pocket we know best.", image: { src: "/areas/borivali-aerial.jpg", alt: "Well kept societies among mature trees, seen from above" } },
        { kicker: "West · East Indian heart", title: "I.C. Colony", text: "A parish from 1547, Mount Poinsur, St. Francis school, the Mandapeshwar caves, and a Christmas market on Brother Cyprian Street. Prices vary more by building age here than anywhere in Borivali.", image: { src: "/sections/svc-resale.jpg", alt: "Residential towers in warm evening light" } },
  ...
  kandivali: {
    ...
    motion: {
      ...
      pocketScenes: [
        ...
        { kicker: "East · against the forest", title: "Thakur Village and Lokhandwala", text: "Thakur Village is about 50,000 people over two square kilometres with wide internal roads and Thakur College since 1992. Lokhandwala Township beside it is the East's premium gated address.", image: { src: "/sections/svc-investment.jpg", alt: "A cluster of tall residential towers" } },
