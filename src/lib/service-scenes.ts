...
export const SERVICE_SCENES: Record<string, ServiceScene> = {
  "resale-flats": {
    ...
    images: [
      { src: "/premium/u/tower-02.jpg", alt: "White residential towers rising against a clear blue sky" },
  ...
  rentals: {
    ...
    images: [
      { src: "/premium/u/interior-01.jpg", alt: "A living room with a deep sofa, full height curtains and a marble media wall" },
  ...
  "new-project-bookings": {
    ...
    images: [
      { src: "/premium/u/tower-09.jpg", alt: "A row of tall white apartment towers with glass balconies" },
  ...
  "investment-advisory": {
    ...
    images: [
      { src: "/premium/u/tower-13.jpg", alt: "Two tall apartment towers seen close, floor upon floor of balconies" },
  ...
  "commercial-plots": {
    ...
    images: [
      { src: "/premium/u/commercial-01.jpg", alt: "The glass facade of an office tower seen from below" },
  ...
  "mhada-paperwork": {
    ...
    images: [
      { src: "/premium/u/paperwork-02.jpg", alt: "Forms being filled in at a desk" },
  ...
  interiors: {
    ...
    images: [
      { src: "/premium/u/interior-02.jpg", alt: "A formal living room with a chandelier and dark wood floor" },
