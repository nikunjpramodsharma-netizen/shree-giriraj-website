...
export const ABOUT_FAQS: AboutFaq[] = [
  ...
  },
  {
    ...
    a: "Six things: resale flats, rentals, new project bookings, society redevelopment, shops and plots, and interior and civil work. Resale is the main business. The firm handles a transaction end to end, from shortlisting and site visits through negotiation, documentation and registration.",
  },
  {
